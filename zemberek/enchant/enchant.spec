...
%package zemberek
Summary: Integration with zemberek for libenchant
Group: System Environment/Libraries
Requires: enchant = %{epoch}:%{version}-%{release}

%description zemberek
Libraries necessary to integrate applications using libenchant with zemberek
...
%build
%configure --enable-myspell --with-myspell-dir=/usr/share/myspell --disable-static --disable-ispell --disable-hspell --enable-zemberek
make %{?_smp_mflags}
...
%files zemberek
%{_libdir}/enchant/lib*_zemberek.so*
